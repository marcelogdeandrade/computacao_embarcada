...
void led_init(int estado){
	...
	_pio_set_output(LED_PIO, LED_PIN_MASK, estado, 0);    // Ativa saída                      (Output ENABLE register)
};
...
void but_init(void){
	...
	_pio_set_input(BUT_PIO, BUT_PIN_MASK, PIO_DEFAULT | PIO_PULLUP | PIO_DEBOUNCE | PIO_DEGLITCH | PIO_OPENDRAIN);
